      ...
      <div className="bg-blue-50 px-4 sm:px-6 py-4 border-t border-blue-200">
        <div className="text-center">
          ...
          <div className="text-xs text-gray-700 space-y-1">
            <p className="font-medium">👤 Regular Login (Blue Button Above):</p>
      ...
      <div className="bg-gradient-to-r from-purple-50 to-pink-50 px-4 sm:px-6 py-3 border-t border-purple-200">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-xs font-semibold text-purple-700">🔒 Super Admin Quick Access</p>
              <p className="text-xs text-gray-600">Restricted to 2 authorized emails only</p>
            </div>
          </div>
          <button
            ...
            title="Only for admin@school.com and ramitgoyal8508@gmail.com"
          >
            🔑 Admin Login
          </button>
        </div>
